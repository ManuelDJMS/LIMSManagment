...
Module Metas2019
    ...
    Public cnt As String = "Data Source=PC92-L;Initial Catalog=MetAs_Live; Integrated Security=true"
    Sub MetodoMetasInf2019()
        Try
            conexion2019 = New SqlConnection("Data Source=PC92-L;Initial Catalog=MetAs_Live; Integrated Security=true")
            conexion2019.Open()
